...
<body>
    ...
    <main class="main-content">
        <div class="add-category" >
           <a href="../pages/categories.php" style="color: white; text-decoration: none"> <button style="border-radius: 20px; background-color: #3A2E2B; padding: 5px; color:aliceblue; cursor:pointer">Crear Categoria</button></a>
        </div>
