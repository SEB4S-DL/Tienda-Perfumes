...
<header>
    ...
    <nav>
        <ul class="main-menu">
            <?php
                $ruta = basename($_SERVER['PHP_SELF']); // Obtener la página actual
            ?>
            <li><a href="/TIENDA-PERFUMES/index.php" class="<?= $ruta == 'index.php' ? 'active' : '' ?>">Inicio</a></li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle <?= $ruta == 'sesionperfumeunisex.php' || $ruta == 'sesionperfumehombre.php' || $ruta == 'sesionperfumemujer.php' ? 'active' : '' ?>">Perfumes <span class="arrow-down">▼</span></a>
    ...
    <div class="search-profile">
        ...
        <!-- Perfil del usuario -->
        <div class="profile">
            <?php if (isset($_SESSION['imagen']) && $_SESSION['imagen'] !== '' && file_exists($_SERVER['DOCUMENT_ROOT']."/TIENDA-PERFUMES/uploads/".$_SESSION['imagen'])): ?>
